...
import Avro.Json.Common exposing (optionalField, strictOptionalField)
            ...
            |> Decode.andThen
                (\tag ->
                    case tag of
                        ...
                        "array" ->
                            Decode.fail "Type name 'array' is reserved."

                        "map" ->
                            Decode.fail "Type name 'map' is reserved."

                        "record" ->
                            Decode.fail "Type name 'record' is reserved."

                        "enum" ->
                            Decode.fail "Type name 'enum' is reserved."

                        "fixed" ->
                            Decode.fail "Type name 'fixed' is reserved."
